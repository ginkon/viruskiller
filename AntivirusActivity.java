...
import com.all.antivirus.dao.AntivirusDao;
import com.all.antivirus.domain.AppInfo;
import com.all.antivirus.engine.APPInfoProvider;
import com.all.antivirus.util.MD5Utils;

import java.util.ArrayList;
import java.util.List;

public class AntivirusActivity extends BaseTouch {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case FINISH:
				...
				if (ainfos!=null&&ainfos.size()>0) {
					...
					builder.setMessage("本次扫描发现"+ainfos.size()+"个病毒,是否立即杀毒！");
					...
					tv_antivirus_safe.setText("已被感染");
				}else{
					tv_antivirus_safe.setVisibility(View.VISIBLE);
				}
				break;
